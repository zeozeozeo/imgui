...
static ImVec2   InputTextCalcTextSizeW(ImGuiContext* ctx, const ImWchar* text_begin, const ImWchar* text_end, const ImWchar** remaining = NULL, ImVec2* out_offset = NULL, bool stop_on_new_line = false, float wrap_width = 0.0f, bool keep_trailing_blanks = false);
...
static ImVec2           FindCharPosition(const ImWchar* text_begin, const ImWchar* char_position, const ImWchar* text_end, float wrap_width);
...
static ImVec2 InputTextCalcTextSizeW(ImGuiContext* ctx, const ImWchar* text_begin, const ImWchar* text_end, const ImWchar** remaining, ImVec2* out_offset, bool stop_on_new_line, float wrap_width, bool keep_trailing_blanks)
{
    ImGuiContext& g = *ctx;
    ImFont* font = g.Font;
    const float line_height = g.FontSize;
...
static void    STB_TEXTEDIT_LAYOUTROW(StbTexteditRow* r, ImGuiInputTextState* obj, int line_start_idx)
{
    ...
    const ImVec2 size = InputTextCalcTextSizeW(obj->Ctx, text + line_start_idx, text + obj->CurLenW, &text_remaining, NULL, true, obj->WordWrapWidth, obj->KeepTrailingBlanks);
    r->x0 = 0.0f;
    r->x1 = size.x;
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    const bool has_word_wrap = is_multiline && (flags & ImGuiInputTextFlags_WordWrap) != 0;
    ...
    if (render_cursor || render_selection)
    {
        ...
        const ImWchar* text_end = state->TextW.Data + ImStrlenW(state->TextW.Data); // FIXME-OPT: this ImStrlenW call is super expensive.
...

        {
            ...
            if (is_multiline)
                text_size = InputTextCalcTextSizeW(&g, text_begin, text_end, NULL, NULL, false, word_wrap_width);
        }
        ...
        if (render_selection)
        {
            ...
            for (const ImWchar* p = text_selected_begin; p < text_selected_end; )
            {
                ...
                {
                    // FIXME: doesn't work with word wrapping
